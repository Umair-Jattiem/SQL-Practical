...
SELECT SalesHeader.ReceiptNumber, SalesLine.SKU, SalesLine.LineTotal, SalesLine.VATAmount
FROM SalesHeader
JOIN SalesLine
ON SalesHeader.TransactionId = SalesLine.TransactionId
WHERE SalesHeader.ReceiptNumber = 'TRX-5005';
